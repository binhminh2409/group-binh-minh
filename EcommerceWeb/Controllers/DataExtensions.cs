...
namespace EcommerceWeb.Controllers
{
    ...
    {
        public static List<OrderDetail> GetDefaultData(this Controller controller)
        {
            ...
            var db = controller.HttpContext.RequestServices.GetRequiredService<EcommerceWebDbContext>();
